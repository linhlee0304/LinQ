...
namespace QLCHThuCung
{
    public partial class FQLNhanVien : Form
    {
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            ...
            if (bUser.DeleteUser(int.Parse(dgDSNV.CurrentRow.Cells[0].Value.ToString())))
            {
        ...
        private void dgDSNV_DoubleClick(object sender, EventArgs e)
        {
            int idNV;
            idNV = int.Parse(dgDSNV.CurrentRow.Cells[0].Value.ToString());
            FDHNhanVien f = new FDHNhanVien();
            f.maNV = idNV;
            f.idD = this.idQL;
            f.ShowDialog();
        }
